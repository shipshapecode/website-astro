export const enigmaTestimonial = {
  name: 'Harley Sugarman',
  title: 'Founder, CEO at Enigma',
  imgSrc: 'harley',
  companyName: 'Enigma',
  svgSrc: 'clients/enigma-white',
...
export const expelTestimonial = {
  name: 'Roger Studner',
  title: 'Chief Architect at Expel',
  imgSrc: 'roger',
  companyName: 'Expel',
  svgSrc: 'clients/expel-white',
...
export const sephoraTestimonial = {
  name: 'Donald Piret',
  title: 'Director of Engineering at Sephora',
  imgSrc: 'donald',
  companyName: 'Sephora',
  svgSrc: 'clients/sephora-white',
