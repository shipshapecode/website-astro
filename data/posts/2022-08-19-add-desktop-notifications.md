...
We are creating the JavaScript class, `NotificationService`, with methods that
...
In the above, we check for service worker support and then register our newly
